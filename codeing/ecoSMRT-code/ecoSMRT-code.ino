 ...
 * Modified for XIAO ESP32S3 Sense
 */

#include <bottleclassifications_inferencing.h>
...
void loop()
{
    ...
    for (uint16_t i = 0; i < EI_CLASSIFIER_LABEL_COUNT; i++) {
        ...
        //ONLY best most confident guess
    ...
    ei_printf("Best prediction: %s (%.5f)\r\n", max_label, max_value);

    if (strcmp(max_label, "bottle") == 0 && max_value > 0.9) {
        ei_printf("Bottle detected!\r\n");
        // pray for ts  
        lidServo.write(0);  // open
        delay(3000);
